...
<?php
   ...
   while($row = mysqli_fetch_array($rs)){
    ...
    echo   "<td>".$row['id']."</td>";
    echo   "<td>".$row['ten']."</td>";
    echo   "<td ><img src = 'uploads/".$row['hinhanh']."'alt = '".$row['hinhanh']."'style = 'width: 60px;height: 60px' ></td>";
    ...
    echo         "<a href='chitietdanhba.php?id=".$row['id']."'>Xem</a>";
                
                 if(!empty($_SESSION['role']) && $_SESSION['role'] == '1'){
                
    echo           "<a href='suadanhba.php?id=".$row['id']."'>Sửa</a>";
    echo          "<a href='xoadanhba.php?id=".$row['id']."'>Xóa</a>";
                  }              
    echo    "</td>";
